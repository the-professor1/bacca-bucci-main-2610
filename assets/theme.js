  ...
  var OpenableElement = class extends CustomHTMLElement {
    ...
    set open(value) {
      if (value) {
        ...
        if ($("body").hasClass("popcoinsModalActive")) {
        } else {
...
`;
  ...
  var ProductForm = class extends HTMLFormElement {
    ...
    async _onSubmit(event) {
      ...
      if (response.ok) {
        ...
        if (typeof showPopCoins === "function") {
          setTimeout(function () {
            showPopCoins();
          }, 1500);
        }
  ...
  var QuickBuyDrawer = class extends DrawerContent {
    ...
    async _load() {
      ...
      if (typeof pdp_buy_now === "function") {
        setTimeout(function () {
          pdp_buy_now();
        }, 2000);
      }
  ...
  var CartDrawer = class extends DrawerContent {
    ...
    async _rerenderCart(event) {
      ...
      setTimeout(async () => {
        ...
        if (typeof showPopCoins === "function") {
          setTimeout(function () {
            sessionStorage.removeItem("popCartAutoCheck");
            sessionStorage.setItem("popCartAutoCheckUpdate", "1");
            showPopCoins();
...
document.addEventListener("DOMContentLoaded", function () {
      ...
      fetch("/pages/lazyload-sections")
        ...
        .then(function (html) {
          let t = new DOMParser()
            ...
            .querySelector("#index-lazyload_sections").innerHTML;
          document.querySelector(".custom-lazyloaded-content").innerHTML = t;
        })
  ...
  document.addEventListener("touchmove", lazyLoad, true);
  document.addEventListener("scroll", lazyLoad, true);

  const scrollableElement = document.querySelector("body");
  scrollableElement.addEventListener("scroll", lazyLoad, true);
});

// Wait for the page to load
// add to cart disbale on load
document.addEventListener("DOMContentLoaded", function () {
  const addToCartButton = document.querySelector("button#AddToCart");
  console.log(!document.querySelector(".product-form__buy-buttons form input[data-no-variant]").dataset.noVariant)
  if(document.querySelector(".product-form__buy-buttons form input[data-no-variant]").dataset.noVariant === 'false'){
